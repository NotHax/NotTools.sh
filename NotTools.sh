...
echo
echo $tes"╔════════════════════════════════════════════════╗"
echo $tes"║ $kuni» $red Author$w   : $cyan NotGuardian                    $w  ║"
echo $tes"║ $kuni» $red Facebook$w : $cyan SmngKa Hax                    $w  ║"
echo $tes"║ $kuni» $red Github$w   : $g https://github.com/NotHax     $w ║"
echo $tes"╚════════════════════════════════════════════════╝"$w
echo ""
sleep 0.8
echo
...
echo $red " ║$kuni 16.$r║$g CCTV Hack"
echo $red " ║$kuni 0.$r ║ Exit"
echo $red " ╚$r════╝$w ════════════════════════════════"
echo 
echo ""
echo  "╭─Choose" |lolcat
